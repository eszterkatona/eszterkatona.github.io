...
(function() {
    ...
    Array.prototype.forEach ||
        (Array.prototype.forEach = function(g, i) {
            ...
            for (var m = 0; m < k; m++)
                m in this && g.call(i, this[m], m, this);
        });
    Array.prototype.map ||
...
(function() {
    ...
    function q(b, j) {
        ...
        this.activate = function() {
            c.monitoring ||
                (c.monitoring = window.setInterval(f, 1e3 / c.p.fps));
            return c;
        };
    ...
    function p(b) {
        ...
        function f(b, d, f) {
            if (
                ...
                (u = a.p.directZooming
                    ? 1 - (m ? a.p.zoomDelta : a.p.dragDelta)
                    : 0),
    ...
    function F(b, g) {
        ...
        this.mousecaptor
            ...
            .bind("mousedown mouseup", function(a) {
                ...
                b.length &&
                    d.dispatch(
                        "mousedown" == a.type ? "downnodes" : "upnodes",
                        b
                    );
            })
            .bind("move", function() {
                ...
                "canvas" == d.domElements[j].nodeName.toLowerCase() &&
                    ...
                    d.domElements[j]
                        ...
                        .clearRect(
                            0,
                            0,
                            d.domElements[j].width,
                            d.domElements[j].height
                        );
        ...
        function f() {
            ...
            if (!v[C].task()) {
                ...
                y = y.filter(function(b) {
                    b.taskParent == a &&
                        v.push({ taskName: b.taskName, task: b.task });
    ...
    sigma.tools.rgbToHex = function(b, g, f) {
        return (
            sigma.tools.toHex(b) + sigma.tools.toHex(g) + sigma.tools.toHex(f)
        );
    };
